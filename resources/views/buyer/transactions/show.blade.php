    ...
    <div class="card elcapo-card">
        ...
        <div class="card-body">
            <div class="row mb-4">
                ...
                <div class="col-md-6">
                    ...
                    @if($transaction->status === 'verified' && $transaction->escrow_receipt)
                        <div class="mt-3">
                            <a href="{{ route('buyer.transactions.download', $transaction) }}" class="btn elcapo-btn">
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <h5 class="elcapo-text-brown">Catatan Penjual</h5>
                    <p>{{ $transaction->seller_notes ?? 'Belum ada catatan' }}</p>
                </div>
            </div>
             <!-- Tombol aksi -->
            <div class="mt-4">
