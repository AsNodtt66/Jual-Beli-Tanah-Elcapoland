                    ...
                    <table class="table table-hover">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="{{ route('seller.transactions.show', $transaction) }}" class="btn btn-sm btn-primary">
                    ...
                    <table class="table table-hover">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td style="color: #8D6B4F;">Rp {{ number_format($transaction->amount, 0, ',', '.') }}</td>
                                <td>{{ $transaction->created_at->format('d M Y') }}</td>
                                <td>{{ $transaction->seller_notes ?? '-' }}</td> <!-- Ubah dari admin_notes ke admin_notes atau seller_notes sesuai database -->
                            </tr>
                            @endforeach
                        </tbody>
                    </table>
